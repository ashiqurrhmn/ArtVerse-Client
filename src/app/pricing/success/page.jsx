...
function SuccessContent() {
  ...
  return (
    ...
    >
      ...
      >
        Thank you for your purchase. Your subscription has been activated and your account is now upgraded.
      </motion.p>
...
export default function SuccessPage() {
  return (
    <main className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Suspense fallback={<div className="text-muted-foreground font-medium animate-pulse">Loading...</div>}>
        <SuccessContent />
      </Suspense>
    </main>
  );
